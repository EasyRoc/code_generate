package com.easyroc.code.generate.common;
...
public class CodeGenerate {
    ...
    public static void main(String[] args) {
        ...
        //手动配置数据源
        String url = "jdbc:mysql://localhost:3306/test?autoReconnect=true&serverTimezone=UTC&useUnicode=true&characterEncoding=utf-8";   //注意修改数据库名
        String name = "root";
        String password = "123456";

        FastAutoGenerator.create(url, name, password)
                .globalConfig(builder -> {
                    builder.author("easyroc") // 设置作者
                ...
                .packageConfig(builder -> {
                    builder.parent("com.easyroc.code.generate") // 设置父包名
                            // .moduleName("system") // 设置父包模块名
                            .pathInfo(Collections.singletonMap(OutputFile.xml, System.getProperty("user.dir") + "/src/main/resources/mapper")); // 设置mapperXml生成路径
                })
                .strategyConfig(builder -> {
                    builder.addInclude("t_his_dict_type") // 设置需要生成的表名
        ...
        FastAutoGenerator.create(url, name, password)
                ...
                .packageConfig(builder -> {
                    builder.parent(parent) // 设置父包名
                            ...
                            .pathInfo(Collections.singletonMap(OutputFile.mapper, System.getProperty("user.dir") + "/src/main/resources/mapper"));    //配置 mapper.xml 路径信息：项目的 resources 目录下
                })
                //4、策略配置
                .strategyConfig(builder -> {
                    builder
